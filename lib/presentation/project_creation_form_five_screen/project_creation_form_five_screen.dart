import 'bloc/project_creation_form_five_bloc.dart';
import 'models/project_creation_form_five_model.dart';
...
class ProjectCreationFormFiveScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<ProjectCreationFormFiveBloc>(
      create: (context) =>
          ProjectCreationFormFiveBloc(ProjectCreationFormFiveState(
        projectCreationFormFiveModelObj: ProjectCreationFormFiveModel(),
      ))
            ..add(ProjectCreationFormFiveInitialEvent()),
      child: ProjectCreationFormFiveScreen(),
    );
  }
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    BlocSelector<
                        ProjectCreationFormFiveBloc,
                        ProjectCreationFormFiveState,
                        ProjectCreationFormFiveModel?>(
                      selector: (state) =>
                          state.projectCreationFormFiveModelObj,
                      builder: (context, projectCreationFormFiveModelObj) {
                        return CustomDropDown(
                          ...
                          items: projectCreationFormFiveModelObj
                                  ?.dropdownItemList ??
                              [],
                          onChanged: (value) {
                            context
                                .read<ProjectCreationFormFiveBloc>()
